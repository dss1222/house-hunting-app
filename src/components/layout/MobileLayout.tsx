...
export function MobileLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-[#17171c]">
      <header className="sticky top-0 z-40 bg-[#17171c] px-5">
        <div className="flex items-center justify-between h-[56px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={signOut}
              className="w-8 h-8 rounded-full bg-[#2c2c35] flex items-center justify-center active:bg-[#3a3a45] transition-colors"
            >
